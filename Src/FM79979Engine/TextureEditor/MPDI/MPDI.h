...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->fixPointModeToolStripMenuItem->Text = L"FixPointMode/­位子修改";
			...
			this->moveWholePathToolStripMenuItem->Text = L"MoveWholePath/移動一條路徑";
			...
			this->rotatePathToolStripMenuItem->Text = L"RotatePath/旋轉一條路徑";
			...
			this->rotateAllPathToolStripMenuItem->Text = L"RotateAllPath/移動所有路徑";
			...
			this->showSelectedImageToolStripMenuItem->Text = L"ShowSelectedImage/顯示所選圖片";
			...
			this->showPath_ToolStripMenuItem->Text = L"ShowPath/顯示路徑";
			...
			this->showErrorMsh_ToolStripMenuItem->Text = L"ShowErrorMessage/顯示錯誤訊息";
			// 
			...
			this->ScaleWithPIAlphaStripPixel_toolStripMenuItem->Text = L"ScaleWithPIAlphaStripPixelProble/ÁY©ñpiÀÉ®×¤¤¥h°£ªºpizel°ÝÃD";
			...
			this->AllPlay_checkBox->Text = L"AllPlay/¥þ³¡¼·©ñ";
			...
			this->AllCurveLoop_checkBox->Text = L"AllCurveLoop/¥þ³¡¸ô®|loop";
