...
rect_xywhf::rect_xywhf(const rect_ltrb& rr,int e_iImageIndex) :iImageIndex(e_iImageIndex), rect_xywh(rr), flipped(false) {}
rect_xywhf::rect_xywhf(int x, int y, int width, int height,int e_iImageIndex) :iImageIndex(e_iImageIndex), rect_xywh(x, y, width, height), flipped(false) {}
rect_xywhf::rect_xywhf() :iImageIndex(-1), flipped(false) {}
