...
namespace XMLDataEditor
{
	...
	///          正確互動。
	/// </summary>
	public ref class ValueInputForm : public System::Windows::Forms::Form
	{
	public:
		ValueInputForm(String^e_str)
		{
			InitializeComponent();
			if( e_str )
				this->Edit_textBox->Text = e_str;
			this->StartPosition = GCFORM::FormStartPosition::CenterScreen;
			//
			//TODO: 在此加入建構函式程式碼
			//
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Edit_textBox->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &ValueInputForm::textBox1_KeyUp);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &ValueInputForm::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &ValueInputForm::button2_Click);
			// 
			// label1
			// 
