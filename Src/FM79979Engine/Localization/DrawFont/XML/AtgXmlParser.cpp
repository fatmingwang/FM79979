...
{    
    ...
    else
    {
        ...
        while( ( m_Ch != '>' ) && ( m_Ch != '/' ) )
        {
            ...
            Attributes[ NumAttrs ].ValueLen = (UINT)( m_pWritePtr - Attributes[ NumAttrs ].strValue );
...
{    
    ...
    m_hFile = CreateFile( strName, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, NULL );    
