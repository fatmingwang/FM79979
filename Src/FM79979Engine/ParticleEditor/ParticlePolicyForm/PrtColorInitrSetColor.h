...
namespace ParticlePolicyForm {
	...
	/// <summary>
	/// PrtColorInitrSetColor 的摘要
	/// </summary>
	public ref class PrtColorInitrSetColor : public System::Windows::Forms::UserControl
	{
	public:
		PrtColorInitrSetColor(float*e_pfR,float*e_pfG,float*e_pfB,float*e_pfA)
		{
			InitializeComponent();
			//
			//TODO: 在此加入建構函式程式碼
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->A_numericUpDown->ValueChanged += gcnew System::EventHandler(this, &PrtColorInitrSetColor::A_numericUpDown_ValueChanged);
			// 
			// label4
			// 
			...
			this->B_numericUpDown->ValueChanged += gcnew System::EventHandler(this, &PrtColorInitrSetColor::B_numericUpDown_ValueChanged);
			// 
			// G_numericUpDown
			// 
			...
			this->G_numericUpDown->ValueChanged += gcnew System::EventHandler(this, &PrtColorInitrSetColor::G_numericUpDown_ValueChanged);
			// 
			// R_numericUpDown
			// 
			...
			this->R_numericUpDown->ValueChanged += gcnew System::EventHandler(this, &PrtColorInitrSetColor::R_numericUpDown_ValueChanged);
			// 
			// label1
			// 
			...
			this->Name = L"PrtColorInitrSetColor";
			this->Size = System::Drawing::Size(124, 103);
