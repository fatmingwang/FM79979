...
{
	System::Void Text::AddText_button_Click(System::Object^  sender, System::EventArgs^  e)
    {
	...
	System::Void Text::DelText_button_Click(System::Object^  sender, System::EventArgs^  e)
	{
	...
	System::Void Text::Text_ListBox_SelectedChanged(System::Object^  sender, System::EventArgs^  e)
	{
		if( m_pFileList->SelectedItem )
		{
	...
	System::Void Text::TreeView_AfterSelect(System::Object^  sender, System::Windows::Forms::TreeViewEventArgs^  e)
	{
