...
public:
	...
	void					ProcessFFTData(sTimeAndPCMData*e_pTimeAndPCMData,float e_fTimeToUpdateFFTData,int e_iNumChannel,int e_iNFrameFFTDataCount,bool e_bDoFilter = false,float e_fFilterEndScaleValue = 1.f,int e_iFilterStrength = 6);
};
