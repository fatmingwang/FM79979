...
public:
	...
	bool								Export(const char*e_strFileName,const char*e_strOriginalSourceFileName);
	...
	bool								ExportBySelectedDecibels(const char*e_strFileName,const char*e_strOriginalSourceFileName);
