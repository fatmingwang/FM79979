...
//Java_com_wh_BluffingGirl_BluffingGirl_stringFromJNI( JNIEnv* env,jobject thiz )
//{
//    return (*env)->NewStringUTF(env, "Hello World");
//}


//void Java_com_wh_BluffingGirl_BluffingGirl_CPlusPlusCall( JNIEnv* env, jobject obj)
//{
//	//MyHello();
//	int a=0;
//	int b=a;
...
void Java_com_wh_BluffingGirlEN_BluffingGirlEN_SensorChange( JNIEnv* env, jobject obj,jfloat e_fX,jfloat e_fY,jfloat e_fZ)
{
...
void Java_com_wh_BluffingGirlEN_BluffingGirlEN_SensorForce( JNIEnv* env, jobject obj,jfloat e_fX)
{
	g_fForce = e_fX;
}

void Java_com_wh_BluffingGirl_BluffingGirl_SensorChange( JNIEnv* env, jobject obj,jfloat e_fX,jfloat e_fY,jfloat e_fZ)
{
	g_fSensorValue[0] = e_fX;
	g_fSensorValue[1] = e_fY;
	g_fSensorValue[2] = e_fZ;
...
void Java_com_wh_BluffingGirl_BluffingGirl_SensorForce( JNIEnv* env, jobject obj,jfloat e_fX)
{
	g_fForce = e_fX;
}
