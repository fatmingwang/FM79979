 ...
 * library, 'libFishingFun.so', and provides access to the
 * exposed C functions.
 * The library is packaged and installed with the application.
 * See the C file, /jni/FishingFun.c file for the
 * implementations of the native methods. 
 * 
 * For more information on JNI, see: http://java.sun.com/docs/books/jni/
 */

public class FishingFun extends NativeActivity implements AccelerometerListener
{
 ...
 //   };
	 ...
	 * 'FishingFun' library when the class is
	 * loaded.
	 */
	static
	{
		System.loadLibrary("FishingFun");
	}
}
