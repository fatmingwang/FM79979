 ...
 */
//extern DECLSPEC const SDLNet_version *  SDLNet_Linked_Version(void);
...
inline int SDLNet_UDP_AddSocket(SDLNet_SocketSet set, UDPsocket sock)
{
    return SDLNet_AddSocket(set, (SDLNet_GenericSocket)sock);
}
...
inline int SDLNet_UDP_DelSocket(SDLNet_SocketSet set, UDPsocket sock)
{
    return SDLNet_DelSocket(set, (SDLNet_GenericSocket)sock);
}
...
inline int _SDLNet_SocketReady(SDLNet_GenericSocket sock)
{
...
inline Uint16 _SDLNet_Read16(const void *areap)
{
