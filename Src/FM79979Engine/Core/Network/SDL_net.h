...
/* Resolve a host name and port to an IP address in network form.
   ...
   If 'host' is nullptr, the resolved host will be set to INADDR_ANY.
 */
#ifndef INADDR_ANY
...
/* Resolve an ip address to a host name in canonical form.
   If the ip couldn't be resolved, this function returns nullptr,
...
/* Get the IP address of the remote system associated with the socket.
   If the socket is a server socket, this function returns nullptr.
*/
...
/* Allocate/resize/free a single UDP packet 'size' bytes long.
   The new packet is returned, or nullptr if the function ran out of memory.
 */
...
/* Allocate/Free a UDP packet vector (array of packets) of 'howmany' packets,
   ...
   A pointer to the first packet in the array is returned, or nullptr if the
...
/* Get the primary IP address of the remote system associated with the 
   ...
   If the channel is not bound and not -1, this function returns nullptr.
 */
...
/* Allocate a socket set for use with SDLNet_CheckSockets()
   This returns a socket set for up to 'maxsockets' sockets, or nullptr if
...
#define SDLNet_SocketReady(sock) \
		((sock != nullptr) && SDL_reinterpret_cast(SDLNet_GenericSocket, sock)->ready)
