...
#define	FVF_BASE_COLOR_TEXTURE			13//just a flag to tell shader to use normal map texture
#define	FVF_NORMAL_MAP_TEXTURE			14
#define	FVF_OCCLUSION_TEXTURE			15
#define	FVF_METALLIC_ROUGHNESS_TEXTURE	16
#define	FVF_EMISSIVE_TEXTURE			17
