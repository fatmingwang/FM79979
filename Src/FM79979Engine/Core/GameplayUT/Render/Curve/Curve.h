...
namespace FATMING_CORE
{
	class cCurve
	{
		bool				m_bDoRecalculateTotalDistance;
	...
	public:
		...
		cCurveWithTime(class TiXmlElement*e_pTiXmlElement);
		CLONE_MYSELF(cCurveWithTime);
		virtual ~cCurveWithTime();
		virtual	class TiXmlElement*		ToTiXmlElement()override;
		virtual bool	ProcessTiXmlElement(class TiXmlElement*e_pTiXmlElement);
		//inherit from cFMTimeLineAnimationRule
