...
bool IsEquivalent(const char* sz1, const char* sz2) { return sz1 == sz2 || (sz1 != nullptr && sz2 != nullptr && strcmp(sz1, sz2) == 0); }
bool IsEquivalent(const std::string& sz1, const char* sz2) { return sz2 != nullptr && strcmp(sz1.c_str(), sz2) == 0; }
bool IsEquivalent(const char* sz1, const std::string& sz2) { return sz1 != nullptr && strcmp(sz1, sz2.c_str()) == 0; }
