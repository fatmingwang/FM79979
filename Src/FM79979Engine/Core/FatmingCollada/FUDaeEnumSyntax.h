...
#define DAE_NURBS_INTERPOLATION						"NURBS"
...
// FCollada enumarated types

#define DAEFC_COLOR_BUFFER								"COLOR"
#define DAEFC_DEPTH_BUFFER								"DEPTH"
#define DAEFC_STENCIL_BUFFER							"STENCIL"
