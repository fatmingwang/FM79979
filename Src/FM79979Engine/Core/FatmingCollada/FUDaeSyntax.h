...
#define DAE_INSTANCE_LOD_NODE_ELEMENT				"instance_lod_node"
...
#define DAE_INITDATA_ELEMENT						"data"
...
#define DAE_DEGREES_SPLINE_INPUT					"DEGREES"
...
#ifdef PREMIUM_EMITTER
#define DAE_BIND_FIELD_ELEMENT						"bind_force_field"
#endif // PREMIUM_EMITTER
...
#define DAE_IMAGER_ELEMENT							"imager"
...
#define DAE_BORDER_COLOR_ELEMENT					"border_color"
...
#define DAESHD_MAYA_STYLE_AMBIENT					"maya_style_ambient"
...
// Note: The following attributes are optional for the image_sequence element
// ////
#define DAEMAYA_IMAGE_SEQUENCE_START					"start"
#define DAEMAYA_IMAGE_SEQUENCE_END						"end"
#define DAEMAYA_IMAGE_SEQUENCE_FPS						"fps"
// ////
...
// FCollada Attribute
#define DAEFC_DEGREE_ATTRIBUTE							"degree"
#define DAEFC_BUFFER_ATTRIBUTE							"buffer"

// Extra types
#define DAEFC_LIBRARIES_TYPE							"libraries"
#define DAEFC_INSTANCES_TYPE							"instances"
#define DAEFC_LODS_TYPE									"LODs"
#define DAEFC_ANALYTICAL_TYPE							"analytical"
#define DAEFC_TRANSFORMS_TYPE							"transforms"
#define DAEFC_LOD_INFO_TYPE								"lod_info"

// FCollada extra transforms
#define DAEFC_TRANSFORM_ORDER							"transform_insert"
#define DAEFC_QUATERNION_ELEMENT						"quaternion"
#define DAEFC_AIM_ELEMENT								"aim_constraint"
#define DAEFC_PATH_ELEMENT								"path_constraint"
#define DAEFC_TARGET_PARAMETER							"target"
#define DAEFC_ROLL_PARAMETER							"roll"
#define DAEFC_PERCENT_ALONG_PARAMETER					"percent_along"
#define DAEFC_WEIGHT_ATTRIBUTE							"weight"

// FCollada LOD Info types
#define DAEFC_MIN_LOD_PIXELS_ATTRIBUTE					"min_lod_pixels"
#define DAEFC_MAX_LOD_PIXELS_ATTRIBUTE					"max_lod_pixels"
#define DAEFC_LOD_BOUNDING_BOX_ATTRIBUTE				"lod_bounding_box"
...
// FCollada syntax for camera depth of field multi-pass effect
...
#define DAEFC_COMPRESSIBLE_IMAGE_PARAMETER				"compressible"
#define DAEFC_LATITUDE_LONGITUDE_ENVIRONMENT_MAP		"latitude_longitude"

#define DAEFC_MESH_LOD_ELEMENT							"mesh_lod"
#define DAEFC_SPLINE_LOD_ELEMENT						"spline_lod"
#define DAEFC_PSURFACE_LOD_ELEMENT						"psurface_lod"
#define DAEFC_LOD_ATTRIBUTE								"level"

#ifdef PREMIUM_EMITTER

// FCD Particle Systems
#define DAEPS_EMITTER_TYPE								"emitter_type"
#define DAEPS_TYPE_PARTICLES_SYSTEM						"type_spray"
#define DAEPS_TYPE_SNOW_SYSTEM							"type_snow"
#define DAEPS_TYPE_SUPER_SPRAY_SYSTEM					"type_superspray"
#define DAEPS_TYPE_BLIZZARD_SYSTEM						"type_blizzard"
#define DAEPS_TYPE_PARRAY_SYSTEM						"type_parray"
#define DAEPS_TYPE_PCLOUD_SYSTEM						"type_pcloud"

#define DAEPS_EMITTER_OBJECT							"emitter_object"

#define DAEPS_VARIANCE_ATTRIBUTE						"variance"

// Base particle params
#define DAEPS_PART_SIZE_PARAMETER						"size"
#define DAEPS_PART_LIFE_PARAMETER						"life"
#define DAEPS_PART_SPEED_PARAMETER						"speed"
#define DAEPS_PART_COLOR								"color"
#define DAEPS_PART_COLOR_VARIATION						"color_var"

// Simple particle params
#define DAEPS_TOT_PARTICLE_PARAMETER					"tot_particles"
#define DAEPS_BIRTH_RATE_PARAMETER						"birth_rate"
#define DAEPS_CONSTANT_PARAMETER						"constant"

// Complex params
#define DAEPS_TOT_AS_RATE_PARAMETER						"total_as_rate"
#define DAEPS_GROW_FOR_PARAMETER						"grow_for"
#define DAEPS_FADE_FOR_PARAMETER						"fade_for"
#define DAEPS_ROT_PHASE_PARAMETER						"rot_phase"
#define DAEPS_ROT_SPEED_PARAMETER						"rot_speed"
#define DAEPS_ROT_AXIS_USR_DEF_PARAMETER				"rot_axis_usr_def"
#define DAEPS_ROT_AXIS_PARAMETER						"rot_axis"
#define DAEPS_SPAWN_RAND_INSTANCE						"rnd_instance"
#define DAEPS_SPAWN_ON_DEATH_PARAMETER					"spawn_on_death"
#define DAEPS_SPAWN_ON_COLLISION_PARAMETER				"spawn_on_collision"
#define DAEPS_SPAWN_COUNT_PARAMETER						"spawn_count"
#define DAEPS_SPAWN_PERCENT_PARAMETER					"spawn_percent"
#define DAEPS_SPAWN_MULT_PARAMETER						"spawn_multiplier"
#define DAEPS_DIR_CHAOS_PARAMETER						"direction_chaos"
#define DAEPS_SPEED_CHAOS_PARAMETER						"speed_chaos"
#define DAEPS_SPEED_CHAOS_TYPE_PARAMETER				"speed_chaos_type"
#define DAEPS_FLAKE_GEOMETRY_PARAMETER					"flake_geometry"

#define DAEPS_MODIFIER_LIST								"modifier_list"
#define DAEPS_MODIFIER_BASIC_ROTATION					"rotation_basic"
#define DAEPS_MODIFIER_ROTATION							"rotation"
#define DAEPS_MODIFIER_VELOCITY_ALIGN					"velocity_align"
#define DAEPS_MODIFIER_RANDOM_OFFSET					"random_offset"
#define DAEPS_MODIFIER_RANDOM_ACCEL						"random_accel"
#define DAEPS_MODIFIER_SIZE_GEN							"generation_size"
#define DAEPS_MODIFIER_COLOR_TINT						"colour_tint"

// Emitter Object params
#define DAEPS_EMISSION_POSITION							"emit_pos"
#define DAEPS_EMISSION_ORIENTATION						"emit_orient"

#define DAEPS_POSITION_AREA								"area"
#define DAEPS_POSITION_RECTANGLE						"box"
#define DAEPS_POSITION_SPHERE							"sphere"
#define DAEPS_POSITION_OBJECT							"object"

#define DAEPS_ORIENTATION_SPHERE						"sphere"
#define DAEPS_ORIENTATION_MATCH_EMITTER					"match_emitter"

// Orientation params -TODO: These are stupid names
#define DAEPS_O_ROLL_MIN								"roll_min"
#define DAEPS_O_ROLL_MAX								"roll_max"
#define DAEPS_O_YAW_MIN									"yaw_min"
#define DAEPS_O_YAW_MAX									"yaw_max"

// Simple public particle params
#define DAEPS_WIDTH_PARAMETER							"width"
#define DAEPS_LENGTH_PARAMETER							"length"
#define DAEPS_HEIGHT_PARAMETER							"length"

#define DAEPS_RADIUS_PARAMETER							"radius"
#define DAEPS_MIN_RADIUS_PARAMETER						"min_radius"
#define DAEPS_MAX_RADIUS_PARAMETER						"max_radius"

#define DAEPS_MESH_OBJECT								"mesh"
#define DAEPS_EMIT_REGULAR								"regular"

// Modifier params
#define DAEPS_M_SIZE									"size"
#define DEAPS_M_GENERATION								"generation"

// rotation params
#define DAEPS_M_ROTATION_INITIAL						"initial"
#define DAEPS_M_ROTATION_INITIAL_VAR					"initial_var"
#define DAEPS_M_ROTATION_SPEED							"speed"
#define DAEPS_M_ROTATION_SPEED_VAR						"speed_var"
#define DEAPS_M_ROTATION_AXIS							"axis"
#define DEAPS_M_ROTATION_AXIS_VAR						"axis_var"
#define DEAPS_M_ROTATION_FLAGS							"flags"

#define DAEPS_M_UP_AXIS									"up_axis"

// random accel params
#define DAEPS_M_ACCEL_SCALE								"accel_scale"
#define DAEPS_M_ACCEL_FREQ								"accel_freq"

// random offset params
#define DAEPS_M_OFFSET_MIN								"min"
#define DAEPS_M_OFFSET_MAX								"max"
#define DAEPS_M_OFFSET_FREQ								"freq"

// color params
#define DAEPS_M_COLOR									"color"
#define DAEPS_M_BLEND_MODE								"blend_mode"
#define DAEPS_M_BLEND_MODE_MULTIPLY						"multiply"
#define DAEPS_M_BLEND_MODE_ADD							"add"
#define DAEPS_M_BLEND_MODE_SUBTRACT						"subtract"
#define DAEPS_M_BLEND_MODE_SET							"set"

// emitter objects
#define DAEPS_EMITTER_OBJECT							"emitter_object"
// Snow params
#define DAEPS_DISPLAY_AS_TRIS_PARAMETER					"display_triangles"

// Blizzard params
#define DAEPS_TUMBLE_PARAMETER							"tumble"
#define DAEPS_TUMBLE_RATE_PARAMETER						"tumble_rate"

// SuperSpray params
#define DAEPS_AXIS_ANGLE								"axis_angle"
#define DAEPS_AXIS_SPREAD								"axis_spread"
#define DAEPS_PLANE_ANGLE								"plane_angle"
#define DAEPS_PLANE_SPREAD								"plane_spread"

// PArray params
#define DAEPS_TARGET_NODE								"target"
#define DAEPS_EMIT_MODE									"emit_mode"
#define DAEPS_DIVERGENCE								"divergence"

// PCloud Params
#define DAEPS_CLOUD_FORMATION_PARAMETER					"cloud_formation_type"
#define DAEPS_FORMATION_NODE_PARAMETER					"formation_node"
#define DAEPS_RANDOM_DIRECTION_PARAMETER				"random_direction"
#define DAEPS_EMIT_DIRECTION_PARAMETER					"emit_direction"


// Forces
#define DAEPS_FORCE_DEFLECTOR_ELEMENT					"force_deflector"
#define DAEPS_FORCE_DRAG_ELEMENT						"force_drag"
#define DAEPS_FORCE_GRAVITY_ELEMENT						"force_gravity"
#define DAEPS_FORCE_PBOMB_ELEMENT						"force_pbomb"
#define DAEPS_FORCE_WIND_ELEMENT						"force_wind"

#define DAEPS_FORM_PARAMETER							"form"
#define DAEPS_SPHERICAL_FORM							"SPHERICAL"
#define DAEPS_PLANAR_FORM								"PLANAR"
#define DAEPS_CYLINDRICAL_FORM							"CYLINDRICAL"

#define DAEPS_BOUNCE_PARAMETER							"bounce"
#define DAEPS_DIAMETER_PARAMETER						"diameter"
#define DAEPS_STRENGTH_PARAMETER						"strength"
#define DAEPS_DECAY_PARAMETER							"decay"
#define DAEPS_TURBULENCE_PARAMETER						"turbulence"
#define DAEPS_FREQUENCY_PARAMETER						"frequency"
#define DAEPS_STARTTIME_PARAMETER						"start_time"
#define DAEPS_ENDTIME_PARAMETER							"end_time"
#define DAEPS_DURATION_PARAMETER						"duration"
#define DAEPS_UNLIMITED_RANGE_PARAMETER					"unlimited_range"

// Force damping for the drag force
#define DAEPS_DAMPING_PERCENT_PARAMETER					"damping_percent"
#define DAEPS_DAMPING_RANGE_PARAMETER					"damping_range"
#define DAEPS_DAMPING_FALLOFF_PARAMETER					"damping_falloff"
