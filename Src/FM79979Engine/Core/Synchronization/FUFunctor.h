...
/** 
	A functor with four arguments.
	@ingroup FUtils
*/
template<class Arg1, class Arg2, class Arg3, class Arg4, class ReturnType>
class IFunctor4
{
public:
	/** Destructor. */
	...
	/** Calls the functor.
		...
		@param argument2 A second argument.
		@param argument3 A third argument.
		@param argument4 A fourth argument.
		@return Implementation-dependent. */
	virtual ReturnType operator()(Arg1 argument1, Arg2 argument2, Arg3 argument3, Arg4 argument4) const = 0;
	...
	/** Returns a copy of this functor.
		@return A copy of this functor. */
	virtual IFunctor4<Arg1, Arg2, Arg3, Arg4, ReturnType>* Copy() const = 0;
};
...
/** 
	...
	@ingroup FUtils
*/
template<class Class, class Arg1, class Arg2, class Arg3, class Arg4, class ReturnType>
class FUFunctor4 : public IFunctor4<Arg1, Arg2, Arg3, Arg4, ReturnType>
{
private:
	Class* m_pObject;
	ReturnType (Class::*m_pFunction) (Arg1, Arg2, Arg3, Arg4);

public:
	/** Constructor.
		@param object An object.
		@param function A member function of this object. */
	FUFunctor4(Class* object, ReturnType (Class::*function) (Arg1, Arg2, Arg3, Arg4)) { m_pObject = object; m_pFunction = function; }
	...
	/** Calls the functor.
		...
		@param argument4 A fourth argument.
		@return Implementation-dependent. */
	virtual ReturnType operator()(Arg1 argument1, Arg2 argument2, Arg3 argument3, Arg4 argument4) const
	{ return ((*m_pObject).*m_pFunction)(argument1, argument2, argument3, argument4); }
	...
	/** Returns a copy of this functor.
		@return A copy of this functor. */
	virtual IFunctor4<Arg1, Arg2, Arg3, Arg4, ReturnType>* Copy() const
	{ return new FUFunctor4<Class, Arg1, Arg2, Arg3, Arg4, ReturnType>(m_pObject, m_pFunction); };
};

/** Shortcut for new FUFunctor3<>.
	@param o An object.
	@param function A member function. */
template <class ClassName, class Argument1, class Argument2, class Argument3, class Argument4, class ReturnType>
inline FUFunctor4<ClassName, Argument1, Argument2, Argument3, Argument4, ReturnType>* NewFUFunctor4(ClassName* o, ReturnType (ClassName::*function) (Argument1, Argument2, Argument3, Argument4))
{
	return new FUFunctor4<ClassName, Argument1, Argument2, Argument3, Argument4, ReturnType>(o, function);
}
...
*/
template<class Arg1, class Arg2, class Arg3, class Arg4, class ReturnType>
class FUStaticFunctor4 : public IFunctor4<Arg1, Arg2, Arg3, Arg4, ReturnType>
{
private:
	ReturnType (*m_pFunction) (Arg1, Arg2, Arg3, Arg4);

public:
	/** Constructor.
		@param function A static function. */
	FUStaticFunctor4(ReturnType (*function) (Arg1, Arg2, Arg3, Arg4)) { m_pFunction = function; }

	/** Destructor. */
	virtual ~FUStaticFunctor4() {}
	...
	/** Calls the functor.
		...
		@return Implementation-dependent. */
	virtual ReturnType operator()(Arg1 argument1, Arg2 argument2, Arg3 argument3, Arg4 argument4) const
	{ return (*m_pFunction)(argument1, argument2, argument3, argument4); }
	...
	/** Returns a copy of this functor.
		@return A copy of this functor. */
	virtual IFunctor4<Arg1, Arg2, Arg3, Arg4, ReturnType>* Copy() const
	{ return new FUStaticFunctor4<Arg1, Arg2, Arg3, Arg4, ReturnType>(m_pFunction); };
};
