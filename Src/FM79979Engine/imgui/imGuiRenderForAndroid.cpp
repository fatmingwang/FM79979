...
// Android data
static double                                   g_ImguiAndroidTime = 0.0;
...
void ImGui_ImplAndroid_NewFrame()
{
    ...
    io.DeltaTime = g_ImguiAndroidTime > 0.0 ? (float)(current_time - g_ImguiAndroidTime) : (float)(1.0f / 60.0f);
    g_ImguiAndroidTime = current_time;
}
